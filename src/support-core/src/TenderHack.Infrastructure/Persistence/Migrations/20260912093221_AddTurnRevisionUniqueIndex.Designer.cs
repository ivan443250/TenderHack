...
namespace TenderHack.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260912093221_AddTurnRevisionUniqueIndex")]
    partial class AddTurnRevisionUniqueIndex
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("TenderHack.Domain.Cases.Turn", "Turns", b1 =>
                        {
                            ...
                            b1.HasIndex("CaseId", "Revision")
                                .IsUnique()
                                .HasDatabaseName("ix_turns_case_id_revision");
