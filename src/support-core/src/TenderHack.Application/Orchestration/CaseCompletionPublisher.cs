...
/// <summary>
/// Shared completion-event/notification emission for the two paths that can complete a case
/// (architecture.md §5.8): user-initiated (`CompleteCaseUseCase`) and support-initiated
...
/// </summary>
public sealed class CaseCompletionPublisher(ITurnEventStream events, INotificationSink notifications)
{
